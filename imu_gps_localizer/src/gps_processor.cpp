...
void GpsProcessor::ComputeJacobianAndResidual(const Eigen::Vector3d& G_p_Gps, 
    ...
    *residual = G_p_Gps - (G_p_I + G_R_I * I_p_Gps_);
    ...
    // Compute jacobian of residual by delta x. reference "quaternion kinematics for ESKF" page.48
    jacobian->setZero();
